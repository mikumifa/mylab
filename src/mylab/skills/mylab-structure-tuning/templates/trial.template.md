...
trial_essence: "<the structural hypothesis being tested in this round>"
...
Detailed design reasoning and code-change logic live in `trials/trial-XXX/references/design.md`.
...
2. Implement the new structural idea and save the code delta notes to `trials/trial-XXX/references/implementation-delta.md`.
3. Train the changed system with preserved raw logs and stable output paths under the run directory.
4. Run evaluation that is directly comparable with the baseline or parent trial.
5. Analyze the result and write the design conclusion to `trials/trial-XXX/references/analysis-focus.md`.
...
Deep analysis of why metrics succeeded or failed lives in `trials/trial-XXX/references/analysis.md`.
...
3. Training and evaluation must stay comparable with the baseline or parent trial.
